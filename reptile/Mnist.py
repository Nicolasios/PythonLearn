# -*- coding: utf-8 -*-
"""
Created on Mon Jan 20 13:35:24 2020
...
# [start]
x_train = mnist_load_img("C:\\Users\\TY\\.spyder-py3\\train-images.idx3-ubyte")
y_train = mnist_load_label("C:\\Users\\TY\\.spyder-py3\\train-labels.idx1-ubyte")

# 将打印出的MNIST数据集中所有的图片存入一个data文件夹下
for i in range(0, 1000):
    path = "C:\\Users\\TY\\.spyder-py3\\data\\data_a\\"
    name = str(i) + ".png"
    mnist_save_img(x_train[i], path, name)
'''
# 按图片标签的不同，打印MNIST数据集的图片存入不同文件夹下
for i in range(0, 50):
    path = "C:\\Users\\TY\\.spyder-py3\\data\\data_c\\" + str(y_train[i]) +"/"
    name = str(i)+".png"
    mnist_save_img(x_train[i], path, name)
...
x_test = mnist_load_img("C:\\Users\\TY\\.spyder-py3\\train-images.idx3-ubyte")
y_test = mnist_load_label("C:\\Users\\TY\\.spyder-py3\\train-labels.idx1-ubyte")
'''
